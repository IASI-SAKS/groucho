...
public class SortFieldTest {
    ...
    public SortFieldTest(){
        String s = "{'f0':0,'f1':0,'f10':0,'f11':0,'f12':0,'f13':0,'f14':0,'f2':0,'f3':0,'f4':0,'f5':0,'f6':0,'f7':0,'f8':0,'f9':0}";
        this.entity = JSON.parseObject(s);
    }
    ...
    public void test_0() throws Exception {
       ...
       com.alibaba.json.bvt.asm.SortFieldTest.V0 entity = new com.alibaba.json.bvt.asm.SortFieldTest.V0();
    ...
    String text = JSON.toJSONString(this.entity, SerializerFeature.SortField);
    System.out.println(text);
    String expected = getSortedString(text);

    Assert.assertEquals(expected, text);

    JSONObject object = JSON.parseObject(text);
    text = JSON.toJSONString(object, SerializerFeature.SortField);
    expected = getSortedString(text);

    Assert.assertEquals(expected, text);

}

    public String getSortedString(String jsonData) throws JSONException, JsonProcessingException {
