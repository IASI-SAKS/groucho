...
//  Sorted ORACLE_DEPTH_DEFAULT	
	private final String ORACLE_DEPTH_DEFAULT = "{dummy-->[]%fieldBoolean-->true%fieldChar-->d%fieldInt-->-1%fieldObject-->[]%fieldString-->deafult%otherDummy-->[]}";

//  Unsorted ORACLE_DEPTH_5	
